...
contract Crowdfunding {
    ...
    modifier campaignOpen() {
        require(state == CampaignState.Active, "Campaign is no longer active");
        _;
    }
    ...
    function fund(uint256 _tierIndex) public payable campaignOpen notPaused {
        ...
        require(msg.value == tiers[_tierIndex].amount, "Invalid amount given");
    ...
    function removeTier(uint256 _index) public onlyOwner {
        require(0 <= _index && _index < tiers.length, "Tier does not exist");
    ...
    function withdraw() public onlyOwner {
        ...
        require(
            ...
            "Campaign is not successfull yet"
        );
